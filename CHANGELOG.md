...
- gstack v0.15.2.1 스킬 가이드 동기화 — 10개 스킬에 음성 입력 섹션 추가 (autoplan, benchmark, codex, connect-chrome, cso, design-html, gstack-upgrade, plan-eng-review, qa, qa-only)
- design-html: 3가지 진입 경로(목업/리뷰 컨텍스트/텍스트 설명) 설명 추가
- gstack-upgrade: v1.1.0 — 자동 업그레이드 및 스누즈 백오프 기능 설명 업데이트

...
- 현재: VitePress 기본 파비콘 (보류 — FINDING-005)
- 향후: gstack 브랜드 마크, 흰색/다크 배경 위 오렌지-앰버
...
| Finding | 내용 | 우선순위 |
|---------|------|---------|
| FINDING-003 | Inter 라틴 폰트 프리로드 제거 (한국어 사이트에서 불필요) | 낮음 |
| FINDING-004 | 홈페이지 스킬 목록 가독성: 스킬 33개에 설명 추가 | 중간 |
| FINDING-005 | 커스텀 파비콘: gstack 브랜드 마크 | 낮음 |
